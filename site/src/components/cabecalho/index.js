...
export default function Cabecalho(){
    ...
    async function listarProdutosCachorro(){
        ...
        try{
            const url=`http://localhost:5000:5022/produto/consulta/header/caes`;
    ...
    async function listarProdutosGato(){
        ...
        try{
            const url=`http://localhost:5000:5022/produto/consulta/header/gatos`;
    ...
    async function listarProdutosPassaro(){
        ...
        try{
            const url=`http://localhost:5000:5022/produto/consulta/header/passaros`;
    ...
    async function listarProdutosPeixe(){
        ...
        try{
            const url=`http://localhost:5000:5022/produto/consulta/header/peixes`;
    ...
    async function listarProdutosOutros(){
        ...
        try{
            const url=`http://localhost:5000:5022/produto/consulta/header/outros`;
