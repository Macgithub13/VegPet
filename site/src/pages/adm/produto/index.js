...
export default function PageProdutoAdm(){
    ...
    async function consultarInfsProduto(){
        ...
        try{
            ...
            const url=`http://localhost:5000:5022/produto/adm/consulta/${id}`;
    ...
    async function consultarImagensProduto(){
        ...
        try{
            ...
            const urlCapa=`http://localhost:5000:5022/imagem/consulta/capa/${id}`;
            const urlSec=`http://localhost:5000:5022/imagem/consulta/sec/${id}`;
    ...
    async function alterarProduto(){
        ...
        try{
            ...
            const url=`http://localhost:5000:5022/produto/alterar/${id}`;
    ...
    async function alterarCapa(){
        ...
        try{
            ...
            const url=`http://localhost:5000:5022/imagem/alterar/capa/${id}`;
    ...
    async function alterarImageSecundaria(){
        ...
        try{
            ...
            if(inserirSec1===false && previaSec1!==''){
                ...
                await axios.put(`http://localhost:5000:5022/imagem/alterar/imageSec/${id}/2`, formData, {
            ...
            if(inserirSec2===false && previaSec2!==''){
                ...
                await axios.put(`http://localhost:5000:5022/imagem/alterar/imageSec/${id}/3`, formData, {
            ...
            if(inserirSec3===false && previaSec3!==''){
                ...
                await axios.put(`http://localhost:5000:5022/imagem/alterar/imageSec/${id}/4`, formData, {
            ...
            if(inserirSec4===false && previaSec4!==''){
                ...
                await axios.put(`http://localhost:5000:5022/imagem/alterar/imageSec/${id}/5`, formData, {
            ...
            if(inserirSec1 && sec1!==''){
                ...
                await axios.post(`http://localhost:5000:5022/imagem/${id}/2/inserir`, formData, {
            ...
            if(inserirSec2 && sec2!==''){
                ...
                await axios.post(`http://localhost:5000:5022/imagem/${id}/3/inserir`, formData, {
            ...
            if(inserirSec3 && sec3!==''){
                ...
                await axios.post(`http://localhost:5000:5022/imagem/${id}/4/inserir`, formData, {
            ...
            if(inserirSec4 && sec4!==''){
                ...
                await axios.post(`http://localhost:5000:5022/imagem/${id}/5/inserir`, formData, {
    ...
    async function deletarProduto(){
        ...
        try{
            const url=`http://localhost:5000:5022/produto/adm/excluir/${id}`;
    ...
    async function deletarImageSec(){
        ...
        try{
            if(excluirSec1){
                ...
                const url=`http://localhost:5000:5022/imagem/deletar/imageSec/${id}/2`;
            ...
            if(excluirSec2){
                ...
                const url=`http://localhost:5000:5022/imagem/deletar/imageSec/${id}/3`;
            ...
            if(excluirSec3){
                ...
                const url=`http://localhost:5000:5022/imagem/deletar/imageSec/${id}/4`;
            ...
            if(excluirSec4){
                ...
                const url=`http://localhost:5000:5022/imagem/deletar/imageSec/${id}/5`;
            ...
            <div className='container-page'>
                ...
                <div className='container-imagens'>
                    ...
                    <div className='imagem-principal'>
                        ...
                        {capaEmAlteracao ? 
                            <label for='alterar-capa-produto' onChange={(e) => {previaImagem(e,0)}}>
                                ...
                                {previaCapa!=='' ?
                                    <img src={previaCapa}/>
                                :
                                    <img src={`http://localhost:5000:5022/${capa}`} alt='Imagem Principal' />}
                        ...
                        :
                        <div>
                            <img src={`http://localhost:5000:5022/${capa}`} alt='imagem não encontrada'/>
                        </div>}
                    </div>
                                ...
                                <div className='div-labels'>
                                    <label for='alterar-sec1' onChange={(e) => {previaImagem(e,1)}}>
                                        ...
                                        :
                                            ...
                                            :
                                                <img src={`http://localhost:5000:5022/${sec1}`} alt=''/>}
                                    ...
                                    <label for='alterar-sec2' onChange={(e) => {previaImagem(e,2)}}>
                                        ...
                                        :
                                            ...
                                            :
                                                <img src={`http://localhost:5000:5022/${sec2}`} alt=''/>}
                                    ...
                                    <label for='alterar-sec3' onChange={(e) => {previaImagem(e,3)}}>
                                        ...
                                        :
                                            ...
                                            :
                                                <img src={`http://localhost:5000:5022/${sec3}`} alt=''/>}
                                    ...
                                    <label for='alterar-sec4' onChange={(e) => {previaImagem(e,4)}}>
                                        ...
                                        :
                                            ...
                                            :
                                                <img src={`http://localhost:5000:5022/${sec4}`} alt=''/>}
                                    ...
                                    <div className='container-labels-excluirSec'>
                                        ...
                                        {sec1!=='' ?
                                            <button onClick={() => {setExcluirSec1(true)}}>
                                                <img src={`http://localhost:5000:5022/${sec1}`}/>
                                        ...
                                        {sec2!=='' ?
                                            <button onClick={() => {setExcluirSec2(true)}}>
                                                <img src={`http://localhost:5000:5022/${sec2}`}/>
                                        ...
                                        {sec3!=='' ?
                                            <button onClick={() => {setExcluirSec3(true)}}>
                                                <img src={`http://localhost:5000:5022/${sec3}`}/>
                                        ...
                                        {sec4!=='' ?
                                            <button onClick={() => {setExcluirSec4(true)}}>
                                                <img src={`http://localhost:5000:5022/${sec4}`}/>
                            ...
                            <div className='container-images-secs'>
                                {infsImagesSecundariasProduto.map(item=>
                                    <div className='div-imagem-sec'> 
                                        <img src={`http://localhost:5000:5022/${item.Imagem}`} alt=''/>
                                    </div>)}
                            </div>}
                    </div>
