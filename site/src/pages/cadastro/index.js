...
export default function Cadastro() {
  ...
  async function CadastrarUsuario() {
    ...
    try {
      ...
      const cadastroCliente = await axios.post('http://129.148.42.252:5022/cliente/Cadastro', dadosCliente);
      ...
      await axios.put('http://129.148.42.252:5022/cliente/alterar', dadosLinkarEndereco);
